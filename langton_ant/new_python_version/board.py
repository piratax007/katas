...
# Todo
# - maybe use argparse to define three different options to start the board
#   - each one cell in the board is white
#   - each one cell in the board is black
#   - each one cell in the board has a different color
